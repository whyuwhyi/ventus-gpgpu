...
class CtrlSigs extends Bundle {
  ...
  val unfu = Bool()
  val mma = Bool()
  val unfu_op = UInt(4.W)
  val unfu_mode = UInt(2.W)
  val mma_shape = UInt(3.W)
  val mma_abtype = UInt(4.W)
  val mma_cdtype = UInt(1.W)
  val mma_alayout = Bool()
  val mma_blayout = Bool()
  val readmask = Bool()
  val writemask = Bool()
  val wxd = Bool()
  val pc=UInt(32.W)
